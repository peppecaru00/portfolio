...
export function mapImages(imageList) {
    ...
    loadingElement.className = 'loading-spinner'; // This class will now be styled by the CSS
    // loadingElement.textContent = 'Loading images...'; // You can comment out or remove this line
    // Or add another class: loadingElement.classList.add('visual-only');
